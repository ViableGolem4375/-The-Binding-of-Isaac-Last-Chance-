...
if EID then
    ...
    EID:addCollectible(DULL_COIN_ID, "Rerolls all item pedestals in the room.#Items are rerolled into ones of 1 lower quality and are guaranteed to be passive items.#If no item pedestals containing quality 1 items or above exist and Isaac holds at least 5 quality 0 items, 5 quality 0 items will be removed from his inventory and replaced with a quality 3 or 4 item.", "Dull Coin")
    ...
    EID:addCollectible(JUBILEES_ITEM, "Sends Isaac to an angel room.# This angel room is separate from the one generated for the floor.# Starts uncharged.#{{Warning}} After being activates 3 times, it will turn into Glowing Page.", "Book of Jubilees")
    EID:addCollectible(JUBILEES_ITEM2, "Sends Isaac to an angel room.# This angel room is separate from the one generated for the floor.# Starts uncharged.#{{Warning}} After being activates 3 times, it will turn into Glowing Page.", "Book of Jubilees 2/3")
    EID:addCollectible(JUBILEES_ITEM3, "Sends Isaac to an angel room.# This angel room is separate from the one generated for the floor.# Starts uncharged.#{{Warning}} After being activates 3 times, it will turn into Glowing Page.", "Book of Jubilees 1/3")
    ...
    EID:addCollectible(POLTERGEIST_ITEM, "Grants an orbital which deals low contact damage and applies a brief fear status effect to enemies which touch it.", "Poltergeist")
